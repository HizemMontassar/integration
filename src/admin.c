...
int add_user(info in)
{
	...
	f=fopen("/home/hizem/Desktop/haroun/src/data/users","a+");
	if (f!=NULL)
	{
...
int add_info(info in,user u,date d)
{
	...
	info=fopen("/home/hizem/Desktop/haroun/src/data/id","a+");
	if (info!=NULL)
	{
...
int mod_user(user u,date d)
{
	...
	f1=fopen("/home/hizem/Desktop/haroun/src/data/id","r");
	f2=fopen("/home/hizem/Desktop/haroun/src/data/mod","a");
	...
	fclose(f1);
  	...
  	remove("/home/hizem/Desktop/haroun/src/data/id");
  	rename("/home/hizem/Desktop/haroun/src/data/mod","/home/hizem/Desktop/haroun/src/data/id");
	return(c);
...
int del_user(user u)
{
	...
	f1=fopen("/home/hizem/Desktop/haroun/src/data/id","r");
	m1=fopen("/home/hizem/Desktop/haroun/src/data/users","r");
	f2=fopen("/home/hizem/Desktop/haroun/src/data/del1","a");
	m2=fopen("/home/hizem/Desktop/haroun/src/data/del2","a");
	...
	remove("/home/hizem/Desktop/haroun/src/data/id");
	rename("/home/hizem/Desktop/haroun/src/data/del1","/home/hizem/Desktop/haroun/src/data/id");
	remove("/home/hizem/Desktop/haroun/src/data/users");
	rename("/home/hizem/Desktop/haroun/src/data/del2","/home/hizem/Desktop/haroun/src/data/users");
	return(v);
...
f=fopen("/home/hizem/Desktop/haroun/src/data/id","r");
	if (f!=NULL)
...
int mod_login(info2 b)
{
	...
	f1=fopen("/home/hizem/Desktop/haroun/src/data/users","r");
	f2=fopen("/home/hizem/Desktop/haroun/src/data/mad","a");
	...
	fclose(f1);
  	...
  	remove("/home/hizem/Desktop/haroun/src/data/users");
  	rename("/home/hizem/Desktop/haroun/src/data/mad","/home/hizem/Desktop/haroun/src/data/users");
	return(c);
}
