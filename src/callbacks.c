...
void
on_button_coach_afficher_clicked       (GtkWidget *object_graphique, gpointer user_data)
{

	GtkWidget *window_coach_afficher;
	window_coach_afficher = create_window_coach_afficher();
	gtk_widget_show(window_coach_afficher);	
	GtkWidget *treeview_coach;
	treeview_coach = lookup_widget(window_coach_afficher,"treeview_coach");
  	coach(treeview_coach);
}


void
on_button_coach_ajout_clicked          (GtkWidget *object_graphique, gpointer user_data)
{
	GtkWidget *window_coach_ajout;
	window_coach_ajout = create_window_coach_ajout();
	gtk_widget_show(window_coach_ajout);
}


void
on_button_coach_supprimer_clicked      (GtkWidget *object_graphique, gpointer user_data)
{

	GtkWidget *window_coach_supprimer;
	window_coach_supprimer = create_window_coach_supprimer();
	gtk_widget_show(window_coach_supprimer);
}


void
on_button_coach_modifier_clicked       (GtkWidget *object_graphique, gpointer user_data)
{
	GtkWidget *window_coach_modifier;
	window_coach_modifier = create_window_coach_modifier();
	gtk_widget_show(window_coach_modifier);
}


void
on_button_coach_quit_clicked           (GtkWidget *object_graphique, gpointer user_data)
{
gtk_main_quit();
}
...
void
on_button_coach_ajout_ok_clicked       (GtkWidget *object_graphique, gpointer user_data)
{

	char id[30];char nom[30];char prenom[30];int jour;int mois;int annee;

	GtkWidget *input1=lookup_widget(object_graphique,"entry_coach_ajout_id");
	GtkWidget *input2=lookup_widget(object_graphique,"entry_coach_ajout_nom");
	GtkWidget *input3=lookup_widget(object_graphique,"entry_coach_ajout_prenom");
  	GtkWidget *j=lookup_widget(object_graphique, "spinbutton_coach_jour");
  	GtkWidget *m=lookup_widget(object_graphique, "spinbutton_coach_mois");
  	GtkWidget *a=lookup_widget(object_graphique, "spinbutton_coach_annee");
	...
	ajouter(id,nom,prenom,jour,mois,annee);
}


void
on_button_coach_supprimer_ok_clicked   (GtkWidget *object_graphique, gpointer user_data)
{
char id[30];char nom[30];char prenom[30];int jour;int mois;int annee;
GtkWidget *input1=lookup_widget(object_graphique,"entry_coach_supprimer_id");
strcpy(id,gtk_entry_get_text(GTK_ENTRY(input1)));
supprimer(id,nom,prenom,jour,mois,annee);
}


void
on_button_coach_modifier_ok_clicked    (GtkWidget *object_graphique, gpointer user_data)
{
	char id[30];char nom[30];char prenom[30];int jour;int mois;int annee;
	GtkWidget *input1=lookup_widget(object_graphique,"entry_coach_modifier_id");
	GtkWidget *input2=lookup_widget(object_graphique,"entry_coach_modifier_nom");
	GtkWidget *input3=lookup_widget(object_graphique,"entry_coach_modifier_prenom");

	GtkWidget *j=lookup_widget(object_graphique, "spinbutton_coach_modifier_jour");
	GtkWidget *m=lookup_widget(object_graphique, "spinbutton_coach_modifier_mois");
	GtkWidget *a=lookup_widget(object_graphique, "spinbutton_coach_modifier_annee");
	...
	modification(id,nom,prenom,jour,mois,annee);
}


void
on_button_coach_afficher_quit_clicked  (GtkWidget *object_graphique, gpointer user_data)
{
	GtkWidget *window_coach_afficher;
	window_coach_afficher=lookup_widget(object_graphique,"window_coach_afficher");
	gtk_widget_hide(window_coach_afficher);
}


void
on_button_coach_ajout_quit_clicked     (GtkWidget *object_graphique, gpointer user_data)
{
	GtkWidget *window_coach_ajout;
	window_coach_ajout=lookup_widget(object_graphique,"window_coach_ajout");
	gtk_widget_hide(window_coach_ajout);
}


void
on_button_coach_supprimer_quit_clicked (GtkWidget *object_graphique, gpointer user_data)
{
	GtkWidget *window_coach_supprimer;
	window_coach_supprimer=lookup_widget(object_graphique,"window_coach_supprimer");
	gtk_widget_hide(window_coach_supprimer);
}


void
on_button_coach_modifier_quit_clicked  (GtkWidget *object_graphique, gpointer user_data)
{
	GtkWidget *window_coach_modifier;
	window_coach_modifier=lookup_widget(object_graphique,"window_coach_modifier");
	gtk_widget_hide(window_coach_modifier);
}
